...
[`T_` constant](../readme#data-types) corresponding to the Ruby class you're
...
even though technically everything in Ruby `is_a? Object`, testing against
`T_OBJECT` only returns true if there is no better fitting constant.
