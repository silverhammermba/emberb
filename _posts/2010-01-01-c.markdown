...
You don't _need_ to know any advanced C concepts in order to use the API; most
...
`Data_Make_Struct()` does the allocation for you _and_ wraps it. We could
rewrite the allocation function from the previous example as such:
