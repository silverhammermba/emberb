...
You should prefer this approach to `rb_eval_string()` and the like whenever
possible. It's faster since it skips the parser and it allows for some
...
If you want to use `super` in your method, pass arguments as a C array to
