...
binding &ndash; like when you `require` code. So local variables in the string
...
[^wrap]: There's also `rb_eval_string_wrap()` but the Ruby source never uses it
         and in all of my tests it behaves exactly the same as
