...
scope while Ruby is using it! For `rb_define_hooked_variable()`, you can pass
`0` for the getter/setter if you don't need both functions.
...
Constants work similarly, but with some additional scope options.
