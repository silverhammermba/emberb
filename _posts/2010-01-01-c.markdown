...
[^types]If you instead want the `VALUE` of the class object, use the
`CLASS_OF()` macro.
...
the method you'll need to define if you want your objects to wrap C data.
...
reference to a nonexistent Ruby object.
...
[^types]: I really don't know why `RB_TYPE_P()` is a thing.
